    ...
    <div class="" id="cuerpo">
      ...
      <div class="w3-main" id="main" style="margin-left:300px;margin-top:43px;">
        ...
        <div class="w3-container cuerpo">
          ...
          <!-- -->
          <!--  PERFIL USUARIO ====================================== -->
          <div class="w3-container perfil_usuario all_user_panel" style="margin-top:30px; padding-bottom: 50px; display:block">
            <h2>
              Perfil
            </h2>
            <div class="w3-row">
              <div class="w3-container w3-col l3 s12 m4">
                <div class="w3-container-fluid" style="height:200px;">
                  <h3>
                    Datos del usuario
                  </h3>
                  <img alt="Norway" class="w3-border" src="img/add.png" style="width:40%;display:inline;"/>
                  <h4>
                    Nombre del usuario
                  </h4>
                </div>
              </div>
              <div class="w3-container w3-col l5 s12 m4">
                <p>
                  nombre_cliente  apellido_cliente_paterno  apellido_cliente_materno  id_etapa  fecha_regreso   id_genero   id_usuario
                </p>
                <p>
              ...
              <div class="w3-container w3-col l4 s12 m4">
            ...
            <!--   <div class="w3-row">
      <div class="w3-container w3-col l4 s12 m4">
         <img alt="Norway" class="w3-border" src="img/add.png" style="width:30%;display:inline;"/>
      </div>
      <div class="w3-container w3-col l4 s12 m4">
         <p>
            Hello W3.CSS Layout.
