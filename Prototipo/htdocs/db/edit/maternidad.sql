...
--
-- Servidor: localhost
-- Tiempo de generación: 02-09-2021 a las 05:37:19
...
CREATE TABLE `bebe` (
  ...
  `nombre_bebe` varchar(255) DEFAULT NULL,
  `fecha_nacimiento_bebe` date DEFAULT NULL,
  `id_genero` int(11) DEFAULT NULL,
  `id_lactancia` int(11) DEFAULT NULL,
  `id_cliente` int(11) DEFAULT NULL,
  `genero` varchar(20) DEFAULT NULL,
  `lactancia` varchar(20) DEFAULT NULL,
  `peso` decimal(8,0) DEFAULT NULL
...
INSERT INTO `cliente` (`id_cliente`, `nombre_cliente`, `apellido_cliente_paterno`, `apellido_cliente_materno`, `id_etapa`, `fecha_regreso`, `id_genero`, `id_usuario`) VALUES
(2, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(3, NULL, NULL, NULL, NULL, NULL, NULL, 27),
(4, NULL, NULL, NULL, NULL, NULL, NULL, 28);
...
INSERT INTO `opciones` (`id_opcion`, `nombre`) VALUES
(1, 'perfil_vacio');
